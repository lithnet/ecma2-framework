...
namespace Lithnet.Ecma2Framework
{
    ...
    public interface IObjectPasswordProvider
    {
        ...
        /// </summary>
        /// <param name="csentry">The identity object representing the entry with the associated password change</param>
        ...
        /// </summary>
        /// <param name="csentry">The identity object representing the entry whose password should be set</param>
        ...
        /// </summary>
        /// <param name="csentry">The identity object representing the entry whose password should be changed</param>
