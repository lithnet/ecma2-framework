...
namespace Lithnet.Ecma2Framework
{
    ...
    public class ExportContext
    {
        ...
        /// <summary>
        /// Creates an <see cref="ExportContext"/> from a worker-side run step and schema.
        /// This factory is the intended entry point for the worker host; it allows the
        /// worker to create an export context from the wire request fields without
        /// depending on internal constructor visibility.
        /// </summary>
        ...
        /// <returns>A fully initialised <see cref="ExportContext"/> ready for use by the orchestrator.</returns>
        public static ExportContext Create(OpenExportConnectionRunStep runStep, Schema types)
        {
            return new ExportContext(runStep, types);
        }
